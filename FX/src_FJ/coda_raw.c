/*********************************************************
**	CODA_RAW.C	: Integrate Visibility in CFS and Disp	**
...
*/
	if( argc < 10 ){
		printf("USAGE : coda_raw [OBS_NAME] [SOURCE] [DELAY CAL] [START] [STOP] [INTEG] [BUNCH] [DEVICE] [AMP] [STN_NAME1] [STN_NAME2] [TOTAL_SS] [SS1] [SS2] ... !!\n");

/*****************************************************************
**	OPEN_SKIP_CODA.C : Load Visibility Phase with P-Cal Correction	**
**																**
**	AUTHOR	: KAMENO Seiji										**
**	CREATED	: 1996/6/27											**
*****************************************************************/
...
int	cfs_timeseries( bl_index, ss_index,  
			freq_num, time_num_cfs, time_incr,
...
*/
	...
	data_index	= 0;
	current_pp	= *position;
	for( data_index=0; data_index<time_num_cfs; data_index ++){

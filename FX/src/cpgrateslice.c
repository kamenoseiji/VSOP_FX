...
int	cpgrateslice( z_ptr, nx, arr_y, x_incr, zmax, max_index )
...
*/
	for( x_index=0; x_index< nx; x_index++){
		ptr_index2 = arr_y* x_index + max_index;	/* RATE Slice	*/
...
*/
	...
	cpglab( "Residual Delay Rate [\\gmsec/sec]", "Corr. Coefficient",

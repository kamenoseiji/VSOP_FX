/*********************************************************
**	CODA_GFF.C	: Global Fringe Search using 			**
**					CODA File System and Enable			**
**					  Real-Time Fringe Correction		**
**														**
**	AUTHOR	: KAMENO Seiji								**
**	CREATED	: 1999/4/13									**
*********************************************************/
...
*/
	if( argc < 8 ){
		printf("USAGE : coda_gff [OBS_NAME] [SOURCE] [START] [STOP] [INTEG] [DEVICE] [TOTAL STN] [TOTAL SS] [STN_NAME1] [STN_NAME2] ... [SS1] [SS2]... !!\n");

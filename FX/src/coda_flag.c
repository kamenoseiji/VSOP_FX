/*********************************************************
**	CODA_FLAG.C	: Survey Visibility Information in 		**
**					CODA File System					**
**														**
**	AUTHOR	: KAMENO Seiji								**
**	CREATED	: 1996/6/27									**
...
*/
		while(ret == 0 ){
			...
			flag[0] = 1;
			cfs226_( &flgunit,&mjd_flag,&current_obj,
					uvw, flag, &spec_num,&ret);
			...
			printf("BL[%d]: OBJ=%03d  FLG=%03d %03d %02d:%02d:%06.2lf (u,v,w) = %15.8e  %15.8e  %15.8e %15.8e\n",
				bl_index+1,  current_obj, flag[0], curr_doy, curr_hh, curr_mm, curr_ss, uvw[0], uvw[1], uvw[2], sqrt(uvw[0]*uvw[0] + uvw[1]*uvw[1] + uvw[2]*uvw[2]));

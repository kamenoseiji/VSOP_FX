/*****************************************************
**	FORT_FMJD2DOY : Convert Modified Julian Data	**
**			 to Day Of Year.						**
**													**
...
long	fort_fmjd2doy_(mjd_ptr, year_ptr, doy_ptr, hh_ptr, mm_ptr, ss_ptr)
	double	*mjd_ptr;	/* INPUT : Modified Julian Date (Pointer) */
...
/*----------------------------- MJD -> YEAR & DOY ----------------------*/
	...
	day			= (long)(*mjd_ptr) - MJD_1901;		/* Days From 1901/1/0 */
	...
	*ss_ptr	= ( *mjd_ptr - (long)(*mjd_ptr) ) * SEC_PER_DAY;

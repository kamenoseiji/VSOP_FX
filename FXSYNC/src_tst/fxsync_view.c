...
#ifdef DEBUG
		if(( recieve = msgrcv(msg_id, &rcv_buf, MSG_SIZ, 0, 0)) < 0){
			printf("Error in [msgrcv in %s] !!\n", argv[0] );
			exit(1);
		}
#endif
